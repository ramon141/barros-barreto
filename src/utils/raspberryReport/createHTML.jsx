...
export async function createRaspberryHTML(raspberry, title) {
    const htmlNotifications = await tableReportPatients(raspberry);
...
async function tableReportPatients(raspberry) {
